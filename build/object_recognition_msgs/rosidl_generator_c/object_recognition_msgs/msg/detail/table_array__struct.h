...
#ifndef OBJECT_RECOGNITION_MSGS__MSG__DETAIL__TABLE_ARRAY__STRUCT_H_
#define OBJECT_RECOGNITION_MSGS__MSG__DETAIL__TABLE_ARRAY__STRUCT_H_
...
#endif  // OBJECT_RECOGNITION_MSGS__MSG__DETAIL__TABLE_ARRAY__STRUCT_H_
