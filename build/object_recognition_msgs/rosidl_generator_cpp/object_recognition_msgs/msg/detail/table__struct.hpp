...
#ifndef OBJECT_RECOGNITION_MSGS__MSG__DETAIL__TABLE__STRUCT_HPP_
#define OBJECT_RECOGNITION_MSGS__MSG__DETAIL__TABLE__STRUCT_HPP_
...
struct Table_
{
  ...
  explicit Table_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_init),
    pose(_init)
  {
    (void)_init;
  ...
  explicit Table_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
    pose(_alloc, _init)
  {
    (void)_init;
...
#endif  // OBJECT_RECOGNITION_MSGS__MSG__DETAIL__TABLE__STRUCT_HPP_
