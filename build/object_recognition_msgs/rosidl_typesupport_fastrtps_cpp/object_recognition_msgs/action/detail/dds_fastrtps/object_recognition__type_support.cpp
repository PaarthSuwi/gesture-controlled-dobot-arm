...
#include "object_recognition_msgs/action/detail/object_recognition__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = object_recognition_msgs::action::ObjectRecognition_Goal;
    is_plain =
      (
      offsetof(DataType, filter_limits) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _ObjectRecognition_Goal__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ObjectRecognition_Goal(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = object_recognition_msgs::action::ObjectRecognition_Result;
    is_plain =
      (
      offsetof(DataType, recognized_objects) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _ObjectRecognition_Result__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ObjectRecognition_Result(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = object_recognition_msgs::action::ObjectRecognition_Feedback;
    is_plain =
      (
...
static size_t _ObjectRecognition_Feedback__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ObjectRecognition_Feedback(full_bounded, is_plain, 0);
...
// functions for object_recognition_msgs::action::ObjectRecognition_Goal already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = object_recognition_msgs::action::ObjectRecognition_SendGoal_Request;
    is_plain =
      (
...
static size_t _ObjectRecognition_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ObjectRecognition_SendGoal_Request(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = object_recognition_msgs::action::ObjectRecognition_SendGoal_Response;
    is_plain =
      (
...
static size_t _ObjectRecognition_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ObjectRecognition_SendGoal_Response(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = object_recognition_msgs::action::ObjectRecognition_GetResult_Request;
    is_plain =
      (
...
static size_t _ObjectRecognition_GetResult_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ObjectRecognition_GetResult_Request(full_bounded, is_plain, 0);
...
// forward declaration of message dependencies and their conversion functions
// functions for object_recognition_msgs::action::ObjectRecognition_Result already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = object_recognition_msgs::action::ObjectRecognition_GetResult_Response;
    is_plain =
      (
...
static size_t _ObjectRecognition_GetResult_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ObjectRecognition_GetResult_Response(full_bounded, is_plain, 0);
...
// functions for object_recognition_msgs::action::ObjectRecognition_Feedback already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = object_recognition_msgs::action::ObjectRecognition_FeedbackMessage;
    is_plain =
      (
...
static size_t _ObjectRecognition_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ObjectRecognition_FeedbackMessage(full_bounded, is_plain, 0);
